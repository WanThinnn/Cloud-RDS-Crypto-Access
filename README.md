...
## Dependencies
* Operating Systems: macOS, Linux. (Currently, Charm-Crypto in this project cannot be developed on Windows using Python. However, there is a similar library available in [Hybrid Ciphertext Policy Attribute Based Encryption Library for C/C++](https://github.com/WanThinnn/Hybrid-CP-ABE-Library))
